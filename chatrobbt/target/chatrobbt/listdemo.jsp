        ...
        <div class="rightCont">
            ...
            <div class="zixun fix">
                ...
                <div class='page fix'>
                    ...
                    <a href='/index/getAll.do?pageNum=1' class='first'>首页</a>
                    <a href='/index/getAll.do?pageNum=${pageInfo.pageNum-1>0?pageInfo.pageNum-1:1}' class='pre'>上一页</a>
                    当前第<span>${pageInfo.navigateFirstPage}/${pageInfo.pages}</span>页
                    <a href='/index/getAll.do?pageNum=${pageInfo.pageNum+1<pageInfo.pages?pageInfo.pageNum+1:pageInfo.pages}' class='next'>下一页</a>
                    <a href='/index/getAll.do?pageNum=${pageInfo.pages}' class='last'>末页</a>
